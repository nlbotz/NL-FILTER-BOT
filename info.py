...
API_ID = int(environ.get('API_ID', '26730349'))
API_HASH = environ.get('API_HASH', '6405e1fd49580221d776f91716163860')
BOT_TOKEN = environ.get('BOT_TOKEN', "8169358651:AAFmR-TO8OVpUt42gCw3ejFNBeh7PaCRywE")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/YjN.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6429451119').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002613661421'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002537595343').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002404102759') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002130955292')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002063594223')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002537595343')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Bbqrpsbdt:Bbqrpsbdt@bbqrpsbdt.bym0gng.mongodb.net/?retryWrites=true&w=majority&appName=Bbqrpsbdt")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MovieSearchee')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Nlmovieb')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MovieSearchee') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/opurbobarmon9')
